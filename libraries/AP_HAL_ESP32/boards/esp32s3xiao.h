...
#define CONFIG_HAL_BOARD_SUBTYPE HAL_BOARD_SUBTYPE_ESP32_S3XIAO

#define TRUE						1
#define FALSE						0

#define HAL_ESP32_BOARD_NAME "esp32s3xiao"
...
//#define HAL_ESP32_ADC_PINS { {0, 1, 1} }
...
#define HAL_ESP32_RCOUT \
	{GPIO_NUM_1, GPIO_NUM_6, GPIO_NUM_2, GPIO_NUM_5}

// SPI Buses
#define HAL_ESP32_SPI_BUSES \
    {.host=SPI3_HOST, .dma_ch=SPI_DMA_CH_AUTO, .mosi=GPIO_NUM_9, .miso=GPIO_NUM_8, .sclk=GPIO_NUM_7}

// SPI Devices
#define HAL_ESP32_SPI_DEVICES \
    {.name=HAL_BARO_NAME, .bus=0, .device=0, .cs=GPIO_NUM_3, .mode=3, .lspeed=1*MHZ, .hspeed=1*MHZ}, \
    {.name=HAL_INS_NAME, .bus=0, .device=1, .cs=GPIO_NUM_4,  .mode=0, .lspeed=2*MHZ, .hspeed=8*MHZ}

//I2C Buses
#define HAL_ESP32_I2C_BUSES \
	{.port=I2C_NUM_0, .sda=GPIO_NUM_41, .scl=GPIO_NUM_42, .speed=400*KHZ, .internal=true}
...
#define AP_NOTIFY_GPIO_LED_1_PIN 21
